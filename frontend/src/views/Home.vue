    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const preparedFiles = computed(() => {
                ...
                console.log('Files before sorting:', files); // Логируем данные перед сортировкой
                console.log('Sort column:', sortColumn.value); // Логируем поле для сортировки
                ...
                console.log('Files after sorting:', sortedFiles); // Логируем данные после сортировки
